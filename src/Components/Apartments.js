...
function Apartments(props){
    let {uppinfo1,uppinfo2,text1,text2,icon1,icon2,icon3,img,price} = props;
    return(
        <div className="appartments" >
            ...
            <div className="downinfo" >
                <span className="icon1" >  <i class="fa-solid fa-bed"></i> {icon1} </span>
                <span className="icon2"> <i class="fa-solid fa-bath"></i>{icon2} </span>
